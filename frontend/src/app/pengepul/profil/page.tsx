...
export default function PengepulProfilPage() {
  ...
  const populateForm = (data: CurrentUserProfile) => {
    ...
    setEmail(data.email || '');
    if (data.pengepul) {
      setNamaPengepul(data.pengepul.nama_pengepul || '');
      setNoTelepon(data.pengepul.no_telepon || '');
      setAlamat(data.pengepul.alamat || '');
    }
    setPassword('');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!namaPengepul.trim()) {
      errors.nama_pengepul = 'Nama pengepul wajib diisi.';
    }
    if (!username.trim()) {
    ...
    if (Object.keys(errors).length > 0) {
      ...
      setToast({
        type: 'error',
        message: 'Mohon periksa kembali isian form yang belum sesuai.',
      });
      return;
    }

    setSaving(true);
    const payload: UpdatePengepulPayload = {
      nama_pengepul: namaPengepul.trim(),
    ...
    if (res.success && res.data) {
      ...
      setToast({
        type: 'success',
        message: res.message || 'Profil pengepul berhasil diperbarui.',
      });
  ...
  return (
    <div className="max-w-[1440px] mx-auto pb-16 font-sans">
      <AdminHeader
        title="Profil Saya"
        subtitle="Kelola informasi data pribadi dan keamanan akun pengepul."
        breadcrumbs={[
          { label: 'Beranda', href: '/pengepul/dashboard' },
          { label: 'Profil Saya' },
        ]}
      />
      ...
      {loading ? (
        <div className="bg-white rounded-2xl border border-gray-200/80 p-16 text-center shadow-sm flex flex-col items-center justify-center min-h-[380px]">
          ...
          <h3 className="text-base font-bold text-gray-900">Memuat Profil Pengepul...</h3>
          <p className="text-xs font-medium text-gray-500 mt-1">
            Mengambil data akun pengepul Anda.
          </p>
        </div>
      ) : (
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white rounded-2xl border border-gray-200/80 p-6 shadow-sm overflow-hidden relative">
              ...
              <div className="relative pt-8 flex flex-col items-center text-center">
                <div className="relative">
                  <div className="h-24 w-24 rounded-full border-4 border-white shadow-md bg-gradient-to-br from-[#22c55e] to-[#16a34a] flex items-center justify-center text-3xl font-extrabold text-white overflow-hidden">
                    {(namaPengepul || username || 'P').charAt(0).toUpperCase()}
                  </div>
                ...
                <h2 className="text-lg font-bold text-gray-900 mt-3.5 leading-tight">
                  {namaPengepul || profile?.username || 'Pengepul Bank Sampah'}
                </h2>
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 space-y-3.5 text-xs">
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[11px] text-gray-400 font-medium">Email Akun</p>
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[11px] text-gray-400 font-medium">No. Telepon / HP</p>
            ...
            <div className="bg-gradient-to-br from-emerald-50/70 to-green-50/30 rounded-2xl border border-emerald-200/60 p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-gray-900">Informasi Pengepul</h4>
                  <p className="text-[12px] text-gray-600 mt-1 leading-relaxed">
                    Data nama dan nomor telepon Anda dapat dilihat oleh petugas untuk koordinasi pengambilan sampah.
                  </p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-200/80 p-6 shadow-sm">
                <div className="flex items-center gap-2.5 pb-4 border-b border-gray-100 mb-5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-gray-900">Data Pengepul</h3>
                    <p className="text-[11px] text-gray-400">Informasi identitas dan kontak Anda</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      placeholder="Alamat lengkap domisili pengepul"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="pengepul@email.com"
                      className={`w-full px-3.5 py-2.5 rounded-xl border text-xs text-gray-800 transition-all focus:outline-none focus:ring-2 ${
                        fieldErrors.email
                          ? 'border-rose-300 focus:border-rose-500 focus:ring-rose-100'
                          : 'border-gray-200 focus:border-[#16a34a] focus:ring-green-100'
