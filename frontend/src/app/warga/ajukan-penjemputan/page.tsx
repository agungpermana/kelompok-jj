        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              >
                <div
                  className={`flex h-9 w-9 items-center justify-center rounded-full font-bold text-sm transition-all shadow-sm ${
                    currentStep === 1
              ...
              <div
                ...
                className={`flex items-center gap-3 cursor-pointer group transition-opacity ${
                  currentStep === 2 ? 'opacity-100' : 'opacity-75 hover:opacity-100'
                }`}
              >
                <div
                  className={`flex h-9 w-9 items-center justify-center rounded-full font-bold text-sm transition-all shadow-sm ${
              ...
              <div
                ...
                className={`flex items-center gap-3 cursor-pointer group transition-opacity ${
                  currentStep === 3 ? 'opacity-100' : 'opacity-75 hover:opacity-100'
                }`}
              >
                <div
                  className={`flex h-9 w-9 items-center justify-center rounded-full font-bold text-sm transition-all shadow-sm ${
