      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-xs flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-extrabold text-gray-900 mt-1">{stats.menunggu}</p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-xs flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-extrabold text-gray-900 mt-1">{stats.terverifikasi}</p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-xs flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-extrabold text-gray-900 mt-1">{stats.ditolak}</p>
          </div>
      ...
      <div className="flex flex-col lg:flex-row gap-3 mb-5">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-2xl text-sm focus:outline-none focus:border-[#16a34a] focus:ring-4 focus:ring-green-100 shadow-xs transition"
          />
        </div>
          ...
          <div className="bg-white rounded-3xl max-w-2xl w-full shadow-2xl border border-gray-100 overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-150">
            ...
            <div className="px-6 py-4.5 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
              <div className="flex items-center gap-3">
                <div
                  className={`h-10 w-10 rounded-2xl flex items-center justify-center flex-shrink-0 border ${
                    actionType === 'setujui'
            ...
            <div className="overflow-y-auto p-6 space-y-5 flex-1 text-xs">
                ...
                >
                  <FileText
                    className={`h-4 w-4 flex-shrink-0 mt-0.5 ${
                      selected.catatan_penolakan ? 'text-rose-600' : 'text-amber-700'
                    }`}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 pt-1">
                ...
                >
                  <div className="space-y-0.5">
                    <p
                      className={`text-[11px] font-semibold uppercase tracking-wide ${
                        actionType === 'ditolak' ? 'text-rose-700' : 'text-emerald-700'
                      }`}
                    >
                      {actionType === 'ditolak'
                  ...
                  <div
                    className={`h-10 w-10 rounded-2xl flex items-center justify-center shadow-2xs border ${
                      actionType === 'ditolak'
            ...
            <div className="p-4 px-6 border-t border-gray-100 bg-gray-50/50 flex items-center justify-end gap-3">
              <button
                ...
                disabled={validating}
                onClick={closeModal}
                className="px-4 py-2.5 border border-gray-200 hover:bg-gray-100 text-gray-700 text-xs font-semibold rounded-xl transition cursor-pointer disabled:opacity-50"
              >
                Batal
              </button>
              ...
              {actionType === 'setujui' && (
                <button
                  ...
                  className="flex items-center gap-1.5 px-5 py-2.5 bg-[#16a34a] hover:bg-[#15803d] text-white text-xs font-bold rounded-xl shadow-xs transition cursor-pointer disabled:opacity-50"
                >
                  {validating ? (
                    <>
              ...
              {actionType === 'ditolak' && (
                <button
                  ...
                  onClick={handleConfirmValidasi}
                  className="flex items-center gap-1.5 px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold rounded-xl shadow-xs transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {validating ? (
                    <>
                      <Loader2 className="h-4 w-4 animate-spin" />
