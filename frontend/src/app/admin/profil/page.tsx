...
export default function AdminProfilPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!namaAdmin.trim()) {
      errors.nama_admin = 'Nama admin wajib diisi.';
    }
    if (!username.trim()) {
    ...
    if (res.success && res.data) {
      ...
      setToast({
        type: 'success',
        message: res.message || 'Profil admin berhasil diperbarui.',
      });
  ...
  return (
    <div className="max-w-[1440px] mx-auto pb-16 font-sans">
      <AdminHeader
        title="Profil Saya"
        subtitle="Kelola informasi data pribadi dan keamanan akun administrator."
        breadcrumbs={[
      ...
      {loading ? (
        <div className="bg-white rounded-2xl border border-gray-200/80 p-16 text-center shadow-sm flex flex-col items-center justify-center min-h-[380px]">
          ...
          <h3 className="text-base font-bold text-gray-900">Memuat Profil Admin...</h3>
          <p className="text-xs font-medium text-gray-500 mt-1">
            Mengambil data akun administrator Anda.
          </p>
        </div>
      ) : (
          ...
          <div className="lg:col-span-4 space-y-6">
              ...
              <div className="relative pt-8 flex flex-col items-center text-center">
                <div className="relative">
                  <div className="h-24 w-24 rounded-full border-4 border-white shadow-md bg-gradient-to-br from-[#22c55e] to-[#16a34a] flex items-center justify-center text-3xl font-extrabold text-white overflow-hidden">
                    {(namaAdmin || username || 'A').charAt(0).toUpperCase()}
                  </div>
                ...
                <h2 className="text-lg font-bold text-gray-900 mt-3.5 leading-tight">
                  {namaAdmin || profile?.username || 'Administrator'}
                </h2>
            ...
            <div className="bg-gradient-to-br from-emerald-50/70 to-green-50/30 rounded-2xl border border-emerald-200/60 p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-gray-900">Informasi Administrator</h4>
                  <p className="text-[12px] text-gray-600 mt-1 leading-relaxed">
                    Sebagai administrator, Anda memiliki akses penuh untuk mengelola seluruh sistem Bank Sampah.
                  </p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-200/80 p-6 shadow-sm">
                <div className="flex items-center gap-2.5 pb-4 border-b border-gray-100 mb-5">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-gray-900">Data Administrator</h3>
                    <p className="text-[11px] text-gray-400">Informasi identitas Anda sebagai admin</p>
                  </div>
                </div>
