...
import { Search, Eye, X, Gift, Coins, Ticket } from 'lucide-react';
...
export default function PenukaranPoinPage() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto pb-16 font-sans">
      ...
      {/* Filters */}
      <div className="bg-white rounded-2xl border border-gray-200/80 p-4 shadow-sm mb-6">
        <div className="flex flex-col md:flex-row items-center gap-3">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:border-[#16a34a] focus:ring-green-100"
            />
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <h3 className="text-base font-bold text-gray-900">Detail Penukaran</h3>
              <button
            ...
            <div className="px-6 py-5 space-y-4">
              {/* Warga Info */}
              <div>
                <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Warga</p>
                <p className="text-sm font-bold text-gray-900">{selected.nama_warga}</p>
                <p className="text-xs text-gray-500">{selected.no_telepon}</p>
              </div>

              {/* Voucher Info */}
              <div className="pt-3 border-t border-gray-100">
                <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Voucher</p>
                <p className="text-sm font-bold text-gray-900">{selected.nama_voucher}</p>
                <p className="text-xs text-gray-500 mt-0.5">{selected.deskripsi_voucher}</p>
              </div>

              {/* Poin Info */}
              <div className="pt-3 border-t border-gray-100">
                <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-2">Rincian Poin</p>
              ...
              {/* Tanggal */}
              <div className="pt-3 border-t border-gray-100">
                <p className="text-[11px] font-semibold text-gray-400 uppercase tracking-wider mb-1">Tanggal Penukaran</p>
                <p className="text-sm font-semibold text-gray-800">{formatDateTime(selected.tanggal_pengajuan)}</p>
              </div>
            </div>
