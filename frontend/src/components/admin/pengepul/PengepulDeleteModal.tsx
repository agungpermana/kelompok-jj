        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1 leading-relaxed">
              Apakah Anda yakin ingin menghapus pengepul{' '}
              <strong className="text-gray-800">{item.namaPengepul}</strong>?
              Akun pengguna (users) terkait ikut terhapus. Tindakan ini tidak
              dapat dibatalkan.
            </p>
          </div>
        </div>
