                ...
                <div key={item.id} className="border border-gray-200 rounded-lg p-4 bg-gray-50/30">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-gray-900 text-sm truncate">{item.namaPengepul}</h3>
                      <p className="text-xs text-gray-500 mt-0.5">Pengepul #{rowNumber}</p>
                    </div>
                    <StatusBadge status={item.user?.status ?? 'aktif'} />
                  </div>
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-700">{item.user?.email || '-'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-500">No. Telepon:</span>
                      <span className="text-gray-700">{item.noTelepon || '-'}</span>
                    </div>
                    <div className="pt-1">
                      <div className="text-gray-500 mb-1">Alamat:</div>
                      <div className="text-gray-700 text-xs leading-relaxed">{item.alamat || '-'}</div>
                    </div>
                  </div>
